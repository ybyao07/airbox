...
typedef enum {
	/** No error. */
	OnlyIdentifierErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	OnlyIdentifierErrorBadArguments = -1001,
	
	/** There was no password. */
	OnlyIdentifierErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	OnlyIdentifierErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	OnlyIdentifierErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	OnlyIdentifierErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	OnlyIdentifierErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	OnlyIdentifierErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	OnlyIdentifierErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	OnlyIdentifierErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	OnlyIdentifierErrorFailedToDecode = errSecDecode
} OnlyIdentifierErrorCode;

extern NSString *const kOnlyIdentifierErrorDomain;

/** Account name. */
extern NSString *const kOnlyIdentifierAccountKey;
 ...
 */
extern NSString *const kOnlyIdentifierCreatedAtKey;

/** Item class. */
extern NSString *const kOnlyIdentifierClassKey;

/** Item description. */
extern NSString *const kOnlyIdentifierDescriptionKey;

/** Item label. */
extern NSString *const kOnlyIdentifierLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kOnlyIdentifierLastModifiedKey;

/** Where the item was created. */
extern NSString *const kOnlyIdentifierWhereKey;
...
/**
 ...
 OnlyIdentifier has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface OnlyIdentifier : NSObject
...
/**
 ...
 See the `NSString` constants declared in OnlyIdentifier.h for a list of keys that can be used when accessing the
